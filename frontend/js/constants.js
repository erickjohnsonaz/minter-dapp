...
const welcome_p = 'Coral Frag Hags are you piece of the Metaverse Reef.  Special Coral Frags with mystical powers grown just for you and harvested, ethically, from the Metaverse Reef.';
...
const p_presale_mint_whitelisted = "You're on the whitelist for the pre-sale! 🎉<br>You may need to manually adjust the GAS to sucessfully mint.";
const p_presale_mint_already_minted = "You've already claimed your whitelist mint. Thank you! 🎉";
const p_public_mint = "No whitelist needed. Public minting is now open! 🎉<br>You may need to manually adjust the GAS to sucessfully mint.";
const button_presale_coming_soon = "Get on the Whitelist";
const button_presale_mint_whitelisted = "Mint Your Special NFT<br>You may need to manually adjust the GAS to sucessfully mint.";
