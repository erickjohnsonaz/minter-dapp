...
const p_presale_mint_whitelisted = "You're on the whitelist for the pre-sale! 🎉 /n You may need to manually adjust the GAS to sucessfully mint.";
const p_presale_mint_already_minted = "You've already claimed your whitelist mint. Thank you! 🎉";
const p_public_mint = "No whitelist needed. Public minting is now open! 🎉 /n You may need to manually adjust the GAS to sucessfully mint.";
